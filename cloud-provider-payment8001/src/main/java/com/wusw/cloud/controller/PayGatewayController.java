...
import com.wusw.cloud.service.PayService;
...
public class PayGatewayController {
    ...
    public Result<String> getGatewayFilter(HttpServletRequest request) {
        ...
        while (headers.hasMoreElements()) {
            ...
            if (headerName.equalsIgnoreCase("X-Request-Wusw1")
                    || headerName.equalsIgnoreCase("X-Request-Wusw2")) {
        ...
        return Result.success("getGatewayFilter 过滤器 test：" + result + "\t ID: " + IdUtil.simpleUUID());
    }
