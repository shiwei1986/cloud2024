package com.wusw.cloud.service.impl;

import com.wusw.cloud.apis.AccountFeignApi;
import com.wusw.cloud.apis.StorageFeignApi;
import com.wusw.cloud.entities.Order;
import com.wusw.cloud.mapper.OrderMapper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void create(Order order) {
        ...
        if (result > 0) {
            ...
            log.info("-------------> 修改订单状态成功，状态为={}",updateResult);
